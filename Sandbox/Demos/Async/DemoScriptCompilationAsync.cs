...
{
    public static class DemoScriptCompilationAsync
    {
        public static async Task StartAsync()
        {
            var evilRobotIds = await GetEvilRobotIdsAsync();
            ...
            var resultSets = await query.CollectResultSetsAsync(3);
        ...
        private static async Task<List<int>> GetEvilRobotIdsAsync()
        {
            return await Db.CollectResultSetAsync("SELECT RobotId FROM Robot WHERE IsEvil = 1;",
